    <main>
        ...
        <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="#">SPARK</a>
                </div>
                <div class="collapse navbar-collapse" id="custom-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Login</a>
                            <ul class="dropdown-menu">
                                <li class="dropdown"><a class="dropdown-toggle" href="index.php?controller=User&action=login" data-toggle="dropdown">Login</a>
                                </li>
                                <li class="dropdown"><a class="dropdown-toggle" href="index.php?controller=User&action=register" data-toggle="dropdown">Register</a>
                                </li>
                            </ul>
                        </li>
        ...
        <div class="main">
            <section class="module bg-dark-30" data-background="public/images/section-8.jpg">
                <div class="container">
                    <div class="row">
                        <!-- LOGIN AREA -->
                    ...
                    <div class="row">
                        <div class="col-sm-5 col-sm-offset-1 mb-sm-40">
                            ...
                            <form class="form" method="POST">
                                ...
                                <div class="form-group"><a href="index.php?controller=User&action=register">Register?</a></div>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <footer class="footer bg-dark">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <p class="copyright font-alt">&copy; 2017&nbsp;<a href="index.html">Spark</a>, All Rights Reserved</p>
                        </div>
                        <div class="col-sm-6">
