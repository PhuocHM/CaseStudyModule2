                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a id="deleteButton" href="#" class="btn btn-danger text-white">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <form method="post">
                                        <div id="modal_main" class="modal-body">
                                            <div class="form-check form-switch">
                                                ...
                                                <input name="role" class="form-check-input" type="radio" id='3' value='3'>
                                                <label class="form-check-label" for="flexSwitchCheckDefault">General Admin</label>
                                            </div>
                                            <div class="form-check form-switch">
                                                <input name="role" class="form-check-input" type="radio" id="2" value='2'>
                                                <label class="form-check-label" for="flexSwitchCheckDefault">Moderator</label>
                                            </div>
                                            <div class="form-check form-switch">
                                                <input name="role" class="form-check-input" type="radio" id="1" value='1'>
                            ...
                            <tbody>
                                <?php foreach ($rows as $key => $value) : ?>
                                    <tr>
                                        ...
                                        <td><?= $value['role'] ?></td>
                                        <td>
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#staticBackdropp" onclick="setRole(<?= $value['id'] . ',' . $value['role'] ?>)">Edit Role</button>
                                            <button type="button" class="btn btn-danger text-white" data-bs-toggle="modal" data-bs-target="#staticBackdrop" onclick="deleteUser(<?= $value['id']; ?>)">Delete</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
